...
export class AuthLocalService {
  ...
  async validateLogin(loginDto: AuthLocalLoginDto): Promise<LoginResponseDto> {
    const user = await this.usersService.findById(loginDto.user);
  ...
  async register(dto: AuthLocalRegisterLoginDto): Promise<void> {
